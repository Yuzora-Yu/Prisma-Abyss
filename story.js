...
const STORY_MANAGER_DATA = {
    ...
    scripts: {
        ...
        "PROLOGUE_HIDDEN_ILLUMINACIA_WIN": [
                ...
                { "name": "？？？？", "text": "……ここまで抗うとは。ならば、正規の歴史にはない道を見届けましょう。" },
                { "name": "システム", "text": "神リュシオンと魔王ゼノンの力が、時の裂け目を越えて戦場へ重なる。" }
        ],
        "PROLOGUE_HIDDEN_ALTAR": [
                { "name": "システム", "text": "時の裂け目の先――本来なら五年後よりさらに先に辿り着くはずの、終焉の祭壇。" },
                { "name": "リュシオン", "charId": 501, "text": "これは正史ではありません。それでも、ここまで歩いたあなたの力を否定はしません。" },
                { "name": "ゼノン", "charId": 402, "text": "深淵王を引きずり出す。勝てるかどうかではない。ここまで来たなら、最後まで付き合え。" },
                { "name": "システム", "text": "時系列の歪みのため、深淵王は完全な力を現世へ固定できていない。" }
        ],
        "PROLOGUE_HIDDEN_END_WIN": [
                { "name": "システム", "text": "五年前には存在し得ない勝利が刻まれた。時の裂け目は白い光に呑まれ、歴史は正規の流れへ戻っていく。" },
                { "name": "システム", "text": "だが、この戦いを越えた力だけは――やり込みへの祝福として、消えずに残った。" }
        ],
        "PROLOGUE_HIDDEN_END_LOSS": [
                { "name": "システム", "text": "不完全な顕現でさえ、深淵王の力は圧倒的だった。四人の意識が闇へ沈む。" },
                { "name": "システム", "text": "それでも、正規の歴史へ戻る直前まで抗い続けた力は、時の裂け目に焼き付いた。" }
        ],
        "BATTLE_RETRY_TALK": [
                {
                        "charId": 9999,
        ...
        "LIGHT_PALACE_FLASHBACK_SAINT_ROOM": [
                ...
                { "name": "システム", "text": "回想中はアルスたちの道具・装備・所持金を使用できない。レイラと聖女ルーナだけで、宮殿入口を目指す。" }
        ],
        ...
        "LIGHT_PALACE_FLASHBACK_VELD1_AFTER": [
                ...
                { "name": "システム", "text": "光と闇が融合することなく、交互に高速循環する。空間が白と黒に瞬間明滅し、ヴェルドの視界が一瞬だけ途切れた。" },
        ...
        "LIGHT_PALACE_FLASHBACK_RETRY_START": [
                { "name": "システム", "text": "――記憶が巻き戻る。聖女の部屋から、もう一度脱出を試みる。" }
        ],
        "LIGHT_PALACE_FLASHBACK_RETRY_POST_VELD": [
                { "name": "システム", "text": "――記憶が巻き戻る。ヴェルドの目をくらませた直後から、三人は再び入口を目指す。" }
        ],
        "LOCKED_LIGHT_PALACE_RECALL": [
                { "name": "システム", "text": "光の宮殿へ向かう前に、雷の要塞でクロードから宮殿内部の出来事を聞く必要がある。" }
        ],
        "QUEST_HAYATE_START": [
                {
                        "name": "ハヤテ",
    ...
    events: {
        ...
        "light_palace_flashback_retry_start": {
                "actions": [ {"type":"CONV","value":"LIGHT_PALACE_FLASHBACK_RETRY_START"}, {"type":"SCENE_RESTORE","id":"saint_room"} ],
                "winActions": []
        },
        "light_palace_flashback_retry_post_veld": {
                "actions": [ {"type":"CONV","value":"LIGHT_PALACE_FLASHBACK_RETRY_POST_VELD"}, {"type":"SCENE_RESTORE","id":"post_veld"} ],
                "winActions": []
        },
        "light_palace_flashback_exit_veld": {
                "actions": [
