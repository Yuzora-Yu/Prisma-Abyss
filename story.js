...
const STORY_MANAGER_DATA = {
    ...
    storyObjectives: {
        ...
        "6-2": "バロンたちを追い、カザリアよりさらに北東の海にある海底火山へ向かおう",
        "6-3": "海底火山の三層を進み、最深部の沈圧研究棟を探ろう",
        "6-4": "沈圧研究棟を抜け、深海調律炉で炎楔のグラドを止めよう",
    ...
    scripts: {
        ...
        "PRESENT_REES_AFTER_TALK": [
                { "name": "リース", "text": "疲れてるなら、寝台を使っていきな。旅に出たって、休みに戻ってくるくらいは構わないさ。" },
                { "name": "システム", "text": "リースの山小屋で休み、仲間たちのHPとMPが全回復した。" }
        ],
        ...
        "PROLOGUE3": [
                ...
                { "charId": 1001, "name": "長老", "text": "先ほど、おぬしが故郷の崩壊を追って旅をしていると聞きました。ならば、ひとつ伝えておきたい話があります。" },
                ...
                { "charId": 1001, "name": "長老", "text": "真偽は分かりません。ただ、あの崩壊以来、各地の属性に妙な揺らぎが増えた。そして今、東の炎の里では炉の火すら制御できなくなっているそうです。" },
                { "charId": 109, "name": "ガイル", "text": "だったら行こうぜ！　困ってる人を放っておけないし、あの日の手がかりもあるかもしれない。" },
        ...
        "FIRE_VOLCANO_GLAD_HP_END": [
            {
                "name": "グラド",
                "text": "くっ……ここまでコントロールできんとは……。"
            }
        ],
        "FIRE_VOLCANO_CLEAR": [
            {
        ...
        "FIRE_VILLAGE_REPORT": [
            ...
            {
                "name": "里の長",
                "text": "プリズムの力は、以前にも王国の儀式により暴走したことがあります。まさか、またあの悪夢を繰り返すつもりでしょうか…"
            },
            {
                "name": "里の長",
        ...
        "WATER_CITY_WIND_MESSENGER": [
                ...
                {
                        "name": "風の集落の使い",
                        "text": "旅の途中で寄っていたアリサって子が、森の奥から風の音がするって言い出して。\n風のプリズムへ祈るだけだって、一人で神殿へ向かったんです。"
                },
                {
                        "name": "風の集落の使い",
                        "text": "神殿までは行ったらしい。でも、そのあと森のもっと奥へ入った跡があって……戻ってこない。\nハイネさんが追ったんですが、今度は二人とも。"
                },
                {
                        "name": "ケイト",
                        "text": "禁忌の森の深部……。放ってはおけません。",
                        "charId": 104
                },
                {
                        "name": "ソフィア",
                        "text": "行ってきな。二人が戻らないなら、今はそっちが先だ。\nその間に私は船の持ち主を調べておくよ。",
                        "charId": 202
                },
                {
                        "name": "ソフィア",
                        "text": "戻る頃には、何かしら掴んでおく。だからあんたたちは、帰ってくる人数を減らすんじゃないよ。",
                        "charId": 202
                }
        ],
        "QUEST_ARISA_HAINE_START": [
                {
                        "name": "風の集落の村人",
                        "text": "アリサは昨日の朝、神殿への古い道を聞きに来た。\n『風が鳴ってる。ちょっと祈ってくるだけ』ってな。"
                },
                {
                        "name": "風の集落の村人",
                        "text": "昼を過ぎても戻らなくて、ハイネ殿が一人で追った。\n森の入口で止めたんだが……『迎えに行くだけだ』って。"
                },
                {
                        "name": "エリーゼ",
                        "charId": 106,
                        "text": "神殿の風は、前よりずっと穏やかなはずです。\nそれなのに、今日は奥から細い音が混じってる。……急ぎましょう。"
                }
        ],
        "QUEST_ARISA_HAINE_ENCOUNTER": [
                {
                        "name": "システム",
                        "text": "折れた枝の向こうで、刃が根を弾く乾いた音がした。"
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                ...
                },
                {
                        "name": "ハイネ",
                        "charId": 207,
                        "text": "見えている。お前は下がれ。足が止まっている。"
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                        "text": "止まってない。ちょっと……風が、うるさいだけ。"
                },
                {
                        "name": "システム",
                        "text": "黒く膨れた根の向こうで、アリサの足元だけ枯葉が逆向きに舞っている。"
                },
                {
                        "name": "ハイネ",
                        "charId": 207,
                        "text": "[N:301]たちか。助かる。話は後だ。手を貸してくれ。"
                }
        ],
        "QUEST_ARISA_HAINE_CLEAR": [
                ...
                {
                        "name": "システム",
                        "text": "倒れた古根の奥。土に半ば埋もれた細い笛が、風に触れてかすかな一音を返した。"
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                ...
                {
                        "name": "システム",
                        "text": "アリサの指が、迷わず古い笛の穴をなぞる。本人はそれに気づくと、すぐ手を止めた。"
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                ...
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                        "text": "分かってる。けど……捨てる気もしない。"
                },
                {
                        "name": "ケイト",
                        "charId": 104,
                        "text": "僕たちは、各地のプリズムを守りながら、五年前から続く異変を追っています。\n今回の風も、たぶん無関係ではありません。"
                },
                {
                        "name": "アリサ",
                        "charId": 108,
                        "text": "……師匠。アタシ、こいつらと行きたい。\n今回の風、知らないふりして帰るの、たぶん無理。"
                },
                {
                        "name": "システム",
                        "text": "ハイネは一度だけ目を細めた。"
        ...
        "WATER_CITY_REXNOTE_BRIEFING": [
                {
                        "name": "ソフィア",
                        "text": "おかえり。二人とも無事か。……こっちも一つ掴んだよ。",
                        "charId": 202
                },
                {
                        "name": "ソフィア",
                        "text": "この辺りの船は軍と商会で押さえられてる。\n自由に動かせそうなのが一隻だけ、旧レクスノート侯爵家に残っている。",
                        "charId": 202
                },
                {
                        "name": "ハイネ",
                ...
                {
                        "name": "ハイネ",
                        "text": "ギルドの依頼で何度か仕事を請けた。護衛、討伐、荷の護衛だ。\n家臣でも友人でもない。だが、依頼の筋は通す人だった。",
                        "charId": 207
                },
                {
                        "name": "ソフィア",
                        "text": "なら話が早い。今の持ち主は息子のアラン＝レクスノート。\n邸は水上都市の外れだ。",
                        "charId": 202
                },
                {
                        "name": "ハイネ",
        ...
        "LIGHTHOUSE_CLEAR": [
                ...
                {
                        "name": "ゼリード",
                        "text": "海底火山だ。王国の記録じゃ空白になってるが、昔の裏仕事じゃ危険な沈圧研究棟として扱われてた。",
                        "charId": 103
                },
                {
                        "name": "ジョセフ",
        ...
        "DARK_CASTLE_CLEAR": [
                ...
                { "name": "ケイト", "text": "……この統合術式。順番が、ない。", "charId": 104 },
                ...
                { "name": "魔王ゼノン", "text": "統合だ。\nあの時に失敗したものを、今度は深淵の側でな。", "charId": 402 },
    ...
    events: {
        ...
        "quest_arisa_haine_clear": {
                "actions": [
                        ...
                        { "type": "ITEM", "id": 701012, "count": 1 },
                        { "type": "QUEST_COMPLETE", "value": "arisa_haine_forest_depths" },
                        { "type": "FLAG", "key": "arisaHaineMainStoryCleared", "refreshField": true },
                        { "type": "SUB", "value": 8 },
                ...
                "actions": [
                        {
                                ...
                                "then": [
                                        ...
                                        },
                                        {
                                                ...
                                                "endAtHpPercent": 50,
                                                "endAtHpConversation": "FIRE_VOLCANO_GLAD_HP_END",
        ...
        "thunder_guild_undersea_volcano_briefing": {
                "actions": [
                        ...
                        { "type": "SUB", "value": 2 },
                        { "type": "LOG", "value": "バロンたちを追い、カザリアよりさらに北東の海にある海底火山へ向かおう。" }
                ],
                "winActions": []
        },
        "undersea_volcano_departure": {
