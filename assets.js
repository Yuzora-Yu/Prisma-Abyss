...
const PRISMA_ASSETS = {
  ...
  graphics: {
    ...
    // Phaser field tiles render at 32x32 (wall faces at 32x48). These runtime
    // copies are pre-scaled with the renderer's nearest-neighbour policy.
    floor: "assets/map/terrain/runtime/terrain_grass_field.png",
    sea: "assets/map/terrain/runtime/terrain_sea.png",
    forest: "assets/map/objects/runtime/object_field_forest.png",
    mountain: "assets/map/objects/runtime/object_field_mountain.png",
    Low_mountain: "assets/map/objects/runtime/object_field_low_mountain.png",
    wall: "assets/map/terrain/runtime/terrain_dungeon_wall.png",
    wall_face: "assets/map/terrain/runtime/terrain_dungeon_wall_face.png",
    wall_face_torch: "assets/map/terrain/runtime/terrain_dungeon_wall_face_torch.png",
    tile_fire_wall_face: "assets/map/terrain/runtime/tile_fire_wall_face.png",
    tile_wind_temple_wall_face: "assets/map/terrain/runtime/tile_wind_temple_wall_face.png",
    tile_wind_hole_wall_face: "assets/map/terrain/runtime/tile_wind_hole_wall_face.png",
    tile_tower_wall_face: "assets/map/terrain/runtime/tile_tower_wall_face.png",
    tile_thunder_wall_face: "assets/map/terrain/runtime/tile_thunder_wall_face.png",
    tile_dark_castle_wall_face: "assets/map/terrain/runtime/tile_dark_castle_wall_face.png",
    tile_galvania_wall_face: "assets/map/terrain/runtime/tile_galvania_wall_face.png",
    tile_grezelia_wall_face: "assets/map/terrain/runtime/tile_grezelia_wall_face.png",
    magma: "assets/map/terrain/runtime/magma.png",
    dungeon_floor: "assets/map/terrain/runtime/terrain_dungeon_floor.png",
    stairs: "assets/map/objects/runtime/object_field_stairs.png",
    stairs_dungeon: "assets/map/objects/runtime/object_dungeon_stairs.png",
    cave: "assets/map/objects/runtime/object_field_cave.png",
    cave_dungeon: "assets/map/terrain/runtime/terrain_dungeon_floor.png",
    hall: "assets/map/objects/runtime/object_field_hall.png",
    "house-1": "assets/map/objects/runtime/object_field_house_1.png",
    "house-2": "assets/map/objects/runtime/object_field_house_2.png",
    village: "assets/map/objects/runtime/object_field_village.png",
    inn: "assets/map/objects/runtime/object_field_inn.png",
    casino: "assets/map/objects/runtime/object_field_casino.png",
    weapon: "assets/map/objects/runtime/object_field_weapon.png",
    shop: "assets/map/objects/runtime/object_field_shop.png",
    medal: "assets/map/objects/runtime/object_field_medal.png",
    town: "assets/map/objects/runtime/object_field_town.png",
    settlement: "assets/map/objects/runtime/object_field_settlement.png",
    castle: "assets/map/objects/runtime/object_field_castle.png",
    temple: "assets/map/objects/runtime/object_field_temple.png",
    fortress: "assets/map/objects/runtime/object_field_fortress.png",
    ruins: "assets/map/objects/runtime/object_field_ruins.png",
    lost: "assets/map/objects/runtime/object_field_lost.png",
    darkcastle: "assets/map/objects/runtime/object_field_darkcastle.png",
    lighthouse: "assets/map/objects/runtime/object_field_lighthouse.png",
    tower: "assets/map/objects/runtime/object_field_tower.png",
    farm: "assets/map/objects/runtime/object_field_farm.png",
    pot_grass: "assets/map/objects/runtime/object_field_pot.png",
    barrel_grass: "assets/map/objects/runtime/object_field_barrel.png",
    chest: "assets/map/objects/runtime/object_field_chest.png",
    chest_rare: "assets/map/objects/runtime/object_field_chest_rare.png",
    chest_dungeon: "assets/map/objects/runtime/object_dungeon_chest.png",
    chest_rare_dungeon: "assets/map/objects/runtime/object_dungeon_chest_rare.png",
    smith: "assets/map/objects/runtime/object_field_smith.png",
    fire_village: "assets/map/objects/runtime/object_field_fire_village.png",
    dummy_grass: "assets/map/objects/runtime/object_field_grass.png",
    boss: "assets/map/objects/runtime/object_field_boss.png",
    boss_dungeon: "assets/map/objects/runtime/object_dungeon_boss.png",
    ...
    item_key_red: "assets/map/objects/runtime/item_key_red.png",
    item_key_blue: "assets/map/objects/runtime/item_key_blue.png",
    item_key_gold: "assets/map/objects/runtime/item_key_gold.png",
    ...
    tile_wind_temple_wall: "assets/map/terrain/runtime/tile_wind_temple_wall.png",
    tile_wind_temple_floor: "assets/map/terrain/runtime/tile_wind_temple_floor.png",
    ...
    tile_light_wall_face: "assets/map/terrain/runtime/tile_light_wall_face.png",
    tile_light_wall_face_prism: "assets/map/terrain/runtime/tile_light_wall_face_prism.png",
    ...
    event_field: "assets/map/objects/runtime/object_field_event.png",
    event_dungeon: "assets/map/objects/runtime/object_dungeon_event.png",
    portal_dungeon: "assets/map/objects/runtime/object_dungeon_portal.png",
  ...
  characterWalk: {
    ...
    sourceSizeById: Object.fromEntries(
      PRISMA_CHARACTER_WALK_IDS.map((id) => [id, id === "301_flying" ? 144 : 32])
    ),
    displaySize: 32,
  ...
  cacheWarmup: {
    ...
    criticalImages: [
      ...
      "assets/map/terrain/runtime/terrain_sea.png",
      "assets/map/objects/runtime/object_field_forest.png",
      "assets/map/objects/runtime/object_field_mountain.png",
      "assets/map/objects/runtime/object_field_low_mountain.png",
      "assets/map/objects/runtime/object_field_cave.png",
      "assets/map/objects/runtime/object_field_house_1.png",
      "assets/map/objects/runtime/object_field_house_2.png",
      "assets/map/objects/runtime/object_field_inn.png",
      ...
      "assets/map/terrain/runtime/terrain_dungeon_wall.png",
      "assets/map/terrain/runtime/terrain_dungeon_floor.png",
