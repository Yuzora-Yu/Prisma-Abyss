...
const PassiveSkill = {
    ...
    MASTER: {
        ...
        4:  { id: 4,  name: '短剣', type: '武器', weaponType: '短剣', params: { atk_pct: 1, cri_pct: 1, eva_pct: 1 }, effect: '短剣装備時にステータスが上昇する', desc: '短剣装備時の攻撃力がスキル%上昇、クリティカル率がスキル%上昇、回避率がスキル%上昇' },
        5:  { id: 5,  name: '弓', type: '武器', weaponType: '弓', params: { atk_pct: 1, cri_pct: 1, hit_pct: 2 }, effect: '弓装備時にステータスが上昇する', desc: '弓装備時の攻撃力がスキル%上昇、クリティカル率がスキル%上昇、命中率がスキル×2%上昇' },
        ...
        22: { id: 22, name: '急所狙い', type: '戦闘', params: { cri_pct: 1 }, effect: 'クリティカル率が上昇する', desc: 'クリティカル率がスキル%上昇' },
        ...
        44: { id: 44, name: '潜伏', type: '防御', params: { target_rate_mult: -2, target_rate_base: -5 }, effect: '敵に狙われる確率が低下する', desc: '攻撃対象に選ばれる確率を(スキル×2)+5%下げる' },
        ...
        50: { id: 50, name: '理力の壁', type: '補助', weaponType: '杖', params: { reflect_dmg_mult: 2, reflect_dmg_base: 10, reflect_trigger_mult: 1, reflect_trigger_base: 5 }, effect: '受けたダメージの一部を反射する', desc: '杖装備時、敵からダメージを受けた時にスキル+5%で発動し、ダメージの(スキル×2)+10%を反射する' },
		51: { id: 51, name: '献身', type: '補助', params: { cover_rate_mult: 5, cover_reduce_mult: 1 }, effect: 'HP50%以下の味方へのダメージを代わりに受ける', desc: 'HP50%以下の味方が狙われた時、スキル×5%でかばう。かばったダメージをスキル%減少する' },
        52: { id: 52, name: '再生', type: '補助', params: { turn_hp_regen_pct: 1 }, effect: '戦闘中HPが回復する', desc: '毎ターン終了時に、自身のHPがスキル%回復する' },
        53: { id: 53, name: '魔力循環', type: '補助', params: { turn_mp_regen_pct: 1 }, effect: '戦闘中MPが回復する', desc: '毎ターン終了時に、自身のMPがスキル%回復する' },
        54: { id: 54, name: '応急手当', type: '補助', params: { post_battle_hp_regen_pct: 1 }, effect: '戦闘後HPが少し回復する', desc: '戦闘終了時に、自身のHPがスキル%回復する' },
        55: { id: 55, name: '魔力充填', type: '補助', params: { post_battle_mp_regen_pct: 1 }, effect: '戦闘後MPが少し回復する', desc: '戦闘終了時に、自身のMPがスキル%回復する' },
