...
ok('undersea volcano procedural floors no longer force maze generation', volcano.floors.slice(0,3).every(floor => floor.procedural === true && floor.forceMaze !== true && floor.proceduralTemplateVersion === 2));
...
ok('service-worker app-shell cache version bumped', swSource.includes('prisma-abyss-v67.20260816'));
