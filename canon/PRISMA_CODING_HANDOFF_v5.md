...
- 光魔剣士の職定義／暫定習得技表は2026-08-15に作成済み。アラン本人の切替タイミング／条件と成長面の最終調整は未確定のため、現時点のruntime職は魔法剣士を維持する。
...
- Phase8Eの将来予定「再加入時+500k」はPhase8Fで**+1,000,000**へ上書き。光魔剣士の暫定職定義は2026-08-15に作成済みだが、アラン本人の切替条件は未確定のため現時点では職変更しない。
